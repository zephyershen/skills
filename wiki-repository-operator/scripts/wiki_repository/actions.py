...
ACTIONS = (
    ...
    Action("tokens", "create", "POST", "/access-tokens", "tokens:manage", "high", "创建个人访问令牌", body_required=True, response_secret=True),
    ...
    Action("changes", "submit", "POST", "/repositories/{repositoryId}/change-requests", "wiki:write", "medium", "提交修改申请", body_required=True),
    Action("changes", "approve", "POST", "/change-requests/{changeRequestId}/approve", "wiki:review", "high", "批准修改申请", body_required=True),
    Action("changes", "reject", "POST", "/change-requests/{changeRequestId}/reject", "wiki:review", "high", "驳回修改申请", body_required=True),
    ...
    Action("knowledge", "ask", "POST", "/projects/{projectId}/ask", "wiki:read", "read", "进行带引用的 Wiki 问答", body_required=True),
    ...
    Action("people", "add", "POST", "/personnel/members", "personnel:manage", "high", "添加 Wiki 平台成员", body_required=True),
    Action("people", "group-create", "POST", "/personnel/groups", "personnel:manage", "medium", "创建人员组", body_required=True),
    Action("people", "group-update", "PATCH", "/personnel/groups/{id}", "personnel:manage", "medium", "修改人员组", body_required=True),
    Action("people", "group-delete", "DELETE", "/personnel/groups/{id}", "personnel:manage", "high", "删除空人员组"),
    Action("people", "user-update", "PATCH", "/personnel/users/{id}", "personnel:manage", "medium", "修改人员角色或人员组", body_required=True),
    Action("people", "management-get", "GET", "/personnel/users/{id}/management", "personnel:manage", "read", "读取人员完整授权"),
    Action("people", "management-set", "PUT", "/personnel/users/{id}/management", "personnel:manage", "high", "保存人员资料和完整授权", body_required=True),
    ...
    Action("access", "project-set", "PUT", "/projects/{projectId}/access/{userId}", "access:manage", "high", "设置 Group 权限", body_required=True),
    Action("access", "project-batch", "POST", "/projects/{projectId}/access/batch", "access:manage", "high", "批量设置 Group 权限", body_required=True),
    Action("access", "namespace-set", "PUT", "/namespaces/{namespaceId}/access/{userId}", "access:manage", "high", "设置 Subgroup 权限", body_required=True),
    Action("access", "namespace-batch", "POST", "/namespaces/{namespaceId}/access/batch", "access:manage", "high", "批量设置 Subgroup 权限", body_required=True),
    Action("access", "repository-set", "PUT", "/repositories/{repositoryId}/access/{userId}", "access:manage", "high", "设置 Wiki 权限", body_required=True),
    Action("access", "repository-batch", "POST", "/repositories/{repositoryId}/access/batch", "access:manage", "high", "批量设置 Wiki 权限", body_required=True),
