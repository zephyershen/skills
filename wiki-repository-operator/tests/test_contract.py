...
class ContractTests(unittest.TestCase):
    def test_current_operator_contract_is_complete(self):
        ...
        self.assertEqual(result["api_operation_count"], 77)
        self.assertEqual(result["managed_api_operation_count"], 76)
        self.assertEqual(result["covered_api_operation_count"], 76)
        self.assertEqual(result["operator_command_count"], 76)
