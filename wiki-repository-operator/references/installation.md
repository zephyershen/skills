...
The user installs only the currently published `global-skills/wiki-repository-operator@1.2.2`. The first CLI command performs this sequence before continuing the requested platform command:
